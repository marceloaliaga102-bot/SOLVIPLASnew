    ...
    <>
      ...
      <aside aria-label="Canva Mode Dock" className="fixed bottom-5 right-5 z-40 flex items-center gap-1.5 sm:gap-2 p-2 rounded-2xl bg-slate-900/95 text-white shadow-2xl border border-emerald-500/50 backdrop-blur-xl animate-fadeIn">
        ...
        <button
          ...
          className="px-2.5 py-1.5 rounded-xl text-xs font-bold bg-slate-800 hover:bg-slate-700 text-emerald-300 border border-emerald-600/40 flex items-center gap-1.5 shadow transition-all hover:scale-105"
          title="Personalizar Logotipo, Icono y Nombre de Marca"
        >
