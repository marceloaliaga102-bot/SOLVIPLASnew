...
export const INITIAL_SITE_CONFIG: SiteConfig = {
  ...
  heroCtaPrimaryText: "Ver Tutorial de Elaboración",
  heroCtaSecondaryText: "Catálogo de Productos",
  heroCtaTertiaryText: "Fórmula & Simulador",
  heroTrust1: "Química Verde: Cero Petróleo",
  heroTrust2: "100% Hidrosoluble en Minutos",
  heroTrust3: "Presupuesto Accesible (S/. 30)",
  ...
  // Modules Section
  modulesBadge: "Navegación Modular por Ventanas",
  modulesTitle: "Explora las Secciones de Solviplas",
  modulesDescription: "Cada sección está organizada de forma independiente para ofrecerte una carga ultra rápida, fluida y una experiencia de navegación interactiva.",

  // Project Overview Section
  overviewBadge: "Datos Generales e Identidad",
  overviewTitle: "Proyecto Sostenible Solviplas",
  overviewAudienceTitle: "Alcance y Comunidad",
  overviewAudienceDesc: "Personas, familias y participantes interesados en soluciones ecológicas que reducen el uso continuo de envolturas y plásticos convencionales.",
  overviewObjectiveTitle: "Objetivo General",
  overviewObjectiveParticipants: "100 Participantes directos en talleres",
  overviewScienceBadge: "Economía Circular & Química Verde",
  overviewScienceTitle: "Transformando materiales cotidianos en soluciones biodegradables",
  overviewScienceDesc: "Siguiendo directrices de la Ellen MacArthur Foundation y principios de química verde, los biopolímeros derivados de fuentes vegetales renovables reducen hasta un 60% la huella de carbono asociada al petróleo. Con Solviplas cualquier persona puede elaborar empaques, fundas y protectores que se disuelven inocuamente en agua al terminar su ciclo de uso.",
  overviewStat1Number: "100 a 500",
  overviewStat1Label: "Años que tarda en degradarse el plástico sintético tradicional",
  overviewStat2Number: "45 seg a 5 min",
  overviewStat2Label: "Tiempo de hidrosolución de Solviplas en agua tibia",
  ...
  problemBadge: "Diagnóstico Ambiental & Realidad",
  problemTitle: "La Problemática de los Plásticos de Un Solo Uso",
  ...
  problemCentralTitle: "Problema Central Identificado",
  problemCentralText: "Contaminación ambiental acelerada por el consumo masivo de polímeros plásticos sintéticos no biodegradables",
  problemEffects: [
  ...
  objectiveBadge: "Metas & Propósito Verde",
  objectiveTitle: "Objetivos y Fines del Proyecto Solviplas",
  objectiveCentralTitle: "Propósito Central",
  objectiveCentralText: "Implementar bioplásticos hidrosolubles y biodegradables accesibles para reemplazar materiales sintéticos",
  objectiveEffects: [
  ...
  recipeBadge: "Fórmula de Química Verde",
  recipeTitle: "Cómo se Elabora Solviplas",
  recipeSubtitle: "Una receta ecológica, segura y económica desarrollada con insumos naturales accesibles con un presupuesto optimizado de S/. 30 soles.",
  recipeStepsTitle: "Pasos de Fabricación Artesanal",
  recipeIngredients: [
  ...
  // Gallery & Results
  galleryBadge: "Evidencia Fotográfica y Audiovisual",
  galleryTitle: "Galería Multimedia de Solviplas",
  gallerySubtitle: "Fotos y videos de los talleres prácticos, las pruebas de solubilidad y los prototipos finales biodegradables.",

  resultsBadge: "Evidencia & Resultados",
  resultsTitle: "Impacto y Validación Práctica de Solviplas",
  resultsSubtitle: "Muestra evaluada de 100 participantes antes y después de los talleres prácticos de formulación ecológica.",
  resultsFindingBadge: "Hallazgo Principal del Proyecto",
  resultsFindingTitle: "Disposición a sustituir el plástico por Solviplas saltó del 2% al 89%",
  resultsFindingDesc: "Antes del taller, la gran mayoría dudaba o desconocía los bioplásticos solubles. Tras experimentar su fabricación con almidón vegetal, 89 de cada 100 participantes manifestaron su total disposición a reemplazar plásticos comunes.",
  resultsBeforePercent: "2%",
  resultsBeforeLabel: "Antes del Taller",
  resultsAfterPercent: "89%",
  resultsAfterLabel: "Después del Taller",

  // Team
  teamBadge: "Equipo de Investigación & Desarrollo Sostenible",
  teamTitle: "Equipo Responsable del Proyecto",
  teamSubtitle: "Personas comprometidas con la reducción de residuos plásticos y la democratización de la química verde.",

  // Community
  communityBadge: "Comunidad & Participación",
  communityTitle: "Comentarios y Preguntas de la Comunidad",
  communitySubtitle: "Miembros de la comunidad, entusiastas del medio ambiente y participantes comparten sus dudas, ideas y experiencias con Solviplas.",

  // Footer & Institutional
  footerCommitmentTitle: "Compromiso Verde",
  footerCommitments: [
  ...
  footerReferencesTitle: "Referencias y Base Científica",
  footerReferences: [
  ...
  footerCopyrightText: "para el medio ambiente y la conservación del planeta.",

  adminUsername: "admin",
  adminEmail: "solf@gmail.com",
